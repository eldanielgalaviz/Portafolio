...
const projects = [
  ...
  },
  {
    ...
    description: "Aplicacion de sistema de control de acceso para un gym mediante tarjetas RFID y Lector de Huellas ",
    image: "/gym.png?height=300&width=500",
    technologies: ["Angular 18", "Node JS", "MySql", "RFID"],
